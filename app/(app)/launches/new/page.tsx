      ...
      <form onSubmit={handleSubmit} className="w-full max-w-2xl space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="flex-1 rounded-full bg-gradient-to-r from-sky-400 via-indigo-500 to-emerald-400 px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-sky-900/30 transition-transform hover:-translate-y-0.5 hover:shadow-sky-900/40 disabled:opacity-50 disabled:cursor-not-allowed"
          >
